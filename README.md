...
1. Extract the installation ZIP. It contains an `AutoCert_0.2.0.0` folder.
...
3. Stop Jellyfin and copy the entire `AutoCert_0.2.0.0` folder into that plugins directory, including its dependency DLLs. Do not copy the source ZIP or `.cs` files there.

...
The manifest references the flat `AutoCert_1.0.2.0.zip` release asset. DLLs must be at the ZIP root because Jellyfin creates the destination plugin folder. Do not substitute the manual-install ZIP, which has an enclosing directory.
